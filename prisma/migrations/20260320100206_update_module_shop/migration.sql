...
INSERT INTO "new_Popup" ("bgColor", "btnColor", "btnLink", "btnText", "createdAt", "description", "id", "image", "isPublished", "shop", "textColor", "title", "updatedAt") SELECT "bgColor", "btnColor", "btnLink", "btnText", "createdAt", "description", "id", "image", "isPublished", "shop", "textColor", "title", "updatedAt" FROM "Popup";
DROP TABLE "Popup";
